// Code generated by internal/gen from Bot API 10.2. DO NOT EDIT.
...
// UnmarshalJSON decodes ChatFullInfo's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ChatFullInfo) UnmarshalJSON(data []byte) error {
	type alias ChatFullInfo // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.AvailableReactions) > 0 && string(aux.AvailableReactions) != "null" {
		...
		if err := json.Unmarshal(aux.AvailableReactions, &raws); err != nil {
			return fmt.Errorf("ChatFullInfo.available_reactions: %w", err)
		}
		out := make([]ReactionType, len(raws))
		for i, r := range raws {
			u, err := unmarshalReactionType(r)
			if err != nil {
				return fmt.Errorf("ChatFullInfo.available_reactions[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.AvailableReactions = out
	}
	return nil
}
...
type Message struct {
	// Unexported bindings set by the dispatcher (see bot.go: bindMessage);
	// the sugar methods in the hand-written files use them.
	api         *api.Client
	fsm         FSMStorage
...
// UnmarshalJSON decodes Message's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *Message) UnmarshalJSON(data []byte) error {
	type alias Message // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.ForwardOrigin) > 0 && string(aux.ForwardOrigin) != "null" {
		u, err := unmarshalMessageOrigin(aux.ForwardOrigin)
		if err != nil {
			return fmt.Errorf("Message.forward_origin: %w", err)
		}
		v.ForwardOrigin = u
	}
	return nil
...
// UnmarshalJSON decodes ExternalReplyInfo's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ExternalReplyInfo) UnmarshalJSON(data []byte) error {
	type alias ExternalReplyInfo // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Origin) > 0 && string(aux.Origin) != "null" {
		u, err := unmarshalMessageOrigin(aux.Origin)
		if err != nil {
			return fmt.Errorf("ExternalReplyInfo.origin: %w", err)
		}
		v.Origin = u
	}
	return nil
...
// UnmarshalJSON decodes PaidMediaInfo's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *PaidMediaInfo) UnmarshalJSON(data []byte) error {
	type alias PaidMediaInfo // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.PaidMedia) > 0 && string(aux.PaidMedia) != "null" {
		...
		if err := json.Unmarshal(aux.PaidMedia, &raws); err != nil {
			return fmt.Errorf("PaidMediaInfo.paid_media: %w", err)
		}
		out := make([]PaidMedia, len(raws))
		for i, r := range raws {
			u, err := unmarshalPaidMedia(r)
			if err != nil {
				return fmt.Errorf("PaidMediaInfo.paid_media[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.PaidMedia = out
...
// UnmarshalJSON decodes InputPollOption's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputPollOption) UnmarshalJSON(data []byte) error {
	type alias InputPollOption // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Media) > 0 && string(aux.Media) != "null" {
		u, err := unmarshalInputPollOptionMedia(aux.Media)
		if err != nil {
			return fmt.Errorf("InputPollOption.media: %w", err)
		}
		v.Media = u
	}
	return nil
...
// UnmarshalJSON decodes BackgroundTypeFill's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *BackgroundTypeFill) UnmarshalJSON(data []byte) error {
	type alias BackgroundTypeFill // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Fill) > 0 && string(aux.Fill) != "null" {
		u, err := unmarshalBackgroundFill(aux.Fill)
		if err != nil {
			return fmt.Errorf("BackgroundTypeFill.fill: %w", err)
		}
		v.Fill = u
	}
	return nil
...
// UnmarshalJSON decodes BackgroundTypePattern's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *BackgroundTypePattern) UnmarshalJSON(data []byte) error {
	type alias BackgroundTypePattern // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Fill json.RawMessage `json:"fill"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Fill) > 0 && string(aux.Fill) != "null" {
		u, err := unmarshalBackgroundFill(aux.Fill)
		if err != nil {
			return fmt.Errorf("BackgroundTypePattern.fill: %w", err)
		}
		v.Fill = u
	}
	return nil
...
// UnmarshalJSON decodes ChatBackground's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ChatBackground) UnmarshalJSON(data []byte) error {
	type alias ChatBackground // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Type) > 0 && string(aux.Type) != "null" {
		u, err := unmarshalBackgroundType(aux.Type)
		if err != nil {
			return fmt.Errorf("ChatBackground.type: %w", err)
		}
		v.Type = u
	}
	return nil
...
// UnmarshalJSON decodes ChatMemberUpdated's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ChatMemberUpdated) UnmarshalJSON(data []byte) error {
	type alias ChatMemberUpdated // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.OldChatMember) > 0 && string(aux.OldChatMember) != "null" {
		u, err := unmarshalChatMember(aux.OldChatMember)
		if err != nil {
			return fmt.Errorf("ChatMemberUpdated.old_chat_member: %w", err)
		}
		v.OldChatMember = u
	}
	if len(aux.NewChatMember) > 0 && string(aux.NewChatMember) != "null" {
		u, err := unmarshalChatMember(aux.NewChatMember)
		if err != nil {
			return fmt.Errorf("ChatMemberUpdated.new_chat_member: %w", err)
		}
		v.NewChatMember = u
	}
	return nil
...
// UnmarshalJSON decodes StoryAreaTypeSuggestedReaction's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *StoryAreaTypeSuggestedReaction) UnmarshalJSON(data []byte) error {
	type alias StoryAreaTypeSuggestedReaction // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.ReactionType) > 0 && string(aux.ReactionType) != "null" {
		u, err := unmarshalReactionType(aux.ReactionType)
		if err != nil {
			return fmt.Errorf("StoryAreaTypeSuggestedReaction.reaction_type: %w", err)
		}
		v.ReactionType = u
	}
	return nil
...
// UnmarshalJSON decodes StoryArea's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *StoryArea) UnmarshalJSON(data []byte) error {
	type alias StoryArea // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Type json.RawMessage `json:"type"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Type) > 0 && string(aux.Type) != "null" {
		u, err := unmarshalStoryAreaType(aux.Type)
		if err != nil {
			return fmt.Errorf("StoryArea.type: %w", err)
		}
		v.Type = u
	}
	return nil
...
// UnmarshalJSON decodes ReactionCount's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ReactionCount) UnmarshalJSON(data []byte) error {
	type alias ReactionCount // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Type json.RawMessage `json:"type"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Type) > 0 && string(aux.Type) != "null" {
		u, err := unmarshalReactionType(aux.Type)
		if err != nil {
			return fmt.Errorf("ReactionCount.type: %w", err)
		}
		v.Type = u
	}
	return nil
...
// UnmarshalJSON decodes MessageReactionUpdated's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *MessageReactionUpdated) UnmarshalJSON(data []byte) error {
	type alias MessageReactionUpdated // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.OldReaction) > 0 && string(aux.OldReaction) != "null" {
		...
		if err := json.Unmarshal(aux.OldReaction, &raws); err != nil {
			return fmt.Errorf("MessageReactionUpdated.old_reaction: %w", err)
		}
		out := make([]ReactionType, len(raws))
		for i, r := range raws {
			u, err := unmarshalReactionType(r)
			if err != nil {
				return fmt.Errorf("MessageReactionUpdated.old_reaction[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.OldReaction = out
	...
	if len(aux.NewReaction) > 0 && string(aux.NewReaction) != "null" {
		...
		if err := json.Unmarshal(aux.NewReaction, &raws); err != nil {
			return fmt.Errorf("MessageReactionUpdated.new_reaction: %w", err)
		}
		out := make([]ReactionType, len(raws))
		for i, r := range raws {
			u, err := unmarshalReactionType(r)
			if err != nil {
				return fmt.Errorf("MessageReactionUpdated.new_reaction[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.NewReaction = out
...
// UnmarshalJSON decodes OwnedGifts's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *OwnedGifts) UnmarshalJSON(data []byte) error {
	type alias OwnedGifts // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Gifts) > 0 && string(aux.Gifts) != "null" {
		...
		if err := json.Unmarshal(aux.Gifts, &raws); err != nil {
			return fmt.Errorf("OwnedGifts.gifts: %w", err)
		}
		out := make([]OwnedGift, len(raws))
		for i, r := range raws {
			u, err := unmarshalOwnedGift(r)
			if err != nil {
				return fmt.Errorf("OwnedGifts.gifts[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Gifts = out
...
// UnmarshalJSON decodes ChatBoost's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ChatBoost) UnmarshalJSON(data []byte) error {
	type alias ChatBoost // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Source) > 0 && string(aux.Source) != "null" {
		u, err := unmarshalChatBoostSource(aux.Source)
		if err != nil {
			return fmt.Errorf("ChatBoost.source: %w", err)
		}
		v.Source = u
	}
	return nil
...
// UnmarshalJSON decodes ChatBoostRemoved's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *ChatBoostRemoved) UnmarshalJSON(data []byte) error {
	type alias ChatBoostRemoved // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Source json.RawMessage `json:"source"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Source) > 0 && string(aux.Source) != "null" {
		u, err := unmarshalChatBoostSource(aux.Source)
		if err != nil {
			return fmt.Errorf("ChatBoostRemoved.source: %w", err)
		}
		v.Source = u
	}
	return nil
...
// UnmarshalJSON decodes RichMessage's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichMessage) UnmarshalJSON(data []byte) error {
	type alias RichMessage // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		...
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichMessage.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichMessage.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes InputRichMessage's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichMessage) UnmarshalJSON(data []byte) error {
	type alias InputRichMessage // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichMessage.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichMessage.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
type InputRichMessageMedia struct {
	...
	Media InputRichMessageMediaSource `json:"media"`
}
...
// UnmarshalJSON decodes RichTextBold's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextBold) UnmarshalJSON(data []byte) error {
	type alias RichTextBold // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextBold.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextItalic's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextItalic) UnmarshalJSON(data []byte) error {
	type alias RichTextItalic // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextItalic.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextUnderline's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextUnderline) UnmarshalJSON(data []byte) error {
	type alias RichTextUnderline // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextUnderline.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextStrikethrough's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextStrikethrough) UnmarshalJSON(data []byte) error {
	type alias RichTextStrikethrough // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextStrikethrough.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextSpoiler's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextSpoiler) UnmarshalJSON(data []byte) error {
	type alias RichTextSpoiler // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextSpoiler.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextDateTime's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextDateTime) UnmarshalJSON(data []byte) error {
	type alias RichTextDateTime // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextDateTime.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextTextMention's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextTextMention) UnmarshalJSON(data []byte) error {
	type alias RichTextTextMention // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextTextMention.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextSubscript's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextSubscript) UnmarshalJSON(data []byte) error {
	type alias RichTextSubscript // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextSubscript.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextSuperscript's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextSuperscript) UnmarshalJSON(data []byte) error {
	type alias RichTextSuperscript // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextSuperscript.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextMarked's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextMarked) UnmarshalJSON(data []byte) error {
	type alias RichTextMarked // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextMarked.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextCode's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextCode) UnmarshalJSON(data []byte) error {
	type alias RichTextCode // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextCode.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextURL's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextURL) UnmarshalJSON(data []byte) error {
	type alias RichTextURL // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextURL.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextEmailAddress's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextEmailAddress) UnmarshalJSON(data []byte) error {
	type alias RichTextEmailAddress // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextEmailAddress.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextPhoneNumber's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextPhoneNumber) UnmarshalJSON(data []byte) error {
	type alias RichTextPhoneNumber // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextPhoneNumber.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextBankCardNumber's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextBankCardNumber) UnmarshalJSON(data []byte) error {
	type alias RichTextBankCardNumber // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextBankCardNumber.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextMention's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextMention) UnmarshalJSON(data []byte) error {
	type alias RichTextMention // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextMention.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextHashtag's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextHashtag) UnmarshalJSON(data []byte) error {
	type alias RichTextHashtag // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextHashtag.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextCashtag's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextCashtag) UnmarshalJSON(data []byte) error {
	type alias RichTextCashtag // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextCashtag.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextBotCommand's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextBotCommand) UnmarshalJSON(data []byte) error {
	type alias RichTextBotCommand // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextBotCommand.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextAnchorLink's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextAnchorLink) UnmarshalJSON(data []byte) error {
	type alias RichTextAnchorLink // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextAnchorLink.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextReference's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextReference) UnmarshalJSON(data []byte) error {
	type alias RichTextReference // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextReference.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichTextReferenceLink's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichTextReferenceLink) UnmarshalJSON(data []byte) error {
	type alias RichTextReferenceLink // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichTextReferenceLink.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockCaption's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockCaption) UnmarshalJSON(data []byte) error {
	type alias RichBlockCaption // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text   json.RawMessage `json:"text"`
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockCaption.text: %w", err)
		}
		v.Text = u
	}
	if len(aux.Credit) > 0 && string(aux.Credit) != "null" {
		u, err := unmarshalRichText(aux.Credit)
		if err != nil {
			return fmt.Errorf("RichBlockCaption.credit: %w", err)
		}
		v.Credit = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockTableCell's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockTableCell) UnmarshalJSON(data []byte) error {
	type alias RichBlockTableCell // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockTableCell.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockListItem's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockListItem) UnmarshalJSON(data []byte) error {
	type alias RichBlockListItem // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichBlockListItem.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichBlockListItem.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes RichBlockParagraph's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockParagraph) UnmarshalJSON(data []byte) error {
	type alias RichBlockParagraph // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockParagraph.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockSectionHeading's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockSectionHeading) UnmarshalJSON(data []byte) error {
	type alias RichBlockSectionHeading // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockSectionHeading.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockPreformatted's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockPreformatted) UnmarshalJSON(data []byte) error {
	type alias RichBlockPreformatted // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockPreformatted.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockFooter's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockFooter) UnmarshalJSON(data []byte) error {
	type alias RichBlockFooter // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockFooter.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockBlockQuotation's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockBlockQuotation) UnmarshalJSON(data []byte) error {
	type alias RichBlockBlockQuotation // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
		Credit json.RawMessage `json:"credit"`
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichBlockBlockQuotation.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichBlockBlockQuotation.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
	...
	if len(aux.Credit) > 0 && string(aux.Credit) != "null" {
		u, err := unmarshalRichText(aux.Credit)
		if err != nil {
			return fmt.Errorf("RichBlockBlockQuotation.credit: %w", err)
		}
		v.Credit = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockPullQuotation's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockPullQuotation) UnmarshalJSON(data []byte) error {
	type alias RichBlockPullQuotation // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text   json.RawMessage `json:"text"`
		Credit json.RawMessage `json:"credit"`
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockPullQuotation.text: %w", err)
		}
		v.Text = u
	}
	if len(aux.Credit) > 0 && string(aux.Credit) != "null" {
		u, err := unmarshalRichText(aux.Credit)
		if err != nil {
			return fmt.Errorf("RichBlockPullQuotation.credit: %w", err)
		}
		v.Credit = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockCollage's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockCollage) UnmarshalJSON(data []byte) error {
	type alias RichBlockCollage // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichBlockCollage.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichBlockCollage.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes RichBlockSlideshow's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockSlideshow) UnmarshalJSON(data []byte) error {
	type alias RichBlockSlideshow // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichBlockSlideshow.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichBlockSlideshow.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes RichBlockTable's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockTable) UnmarshalJSON(data []byte) error {
	type alias RichBlockTable // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Caption) > 0 && string(aux.Caption) != "null" {
		u, err := unmarshalRichText(aux.Caption)
		if err != nil {
			return fmt.Errorf("RichBlockTable.caption: %w", err)
		}
		v.Caption = u
	}
	return nil
...
// UnmarshalJSON decodes RichBlockDetails's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockDetails) UnmarshalJSON(data []byte) error {
	type alias RichBlockDetails // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.Summary) > 0 && string(aux.Summary) != "null" {
		u, err := unmarshalRichText(aux.Summary)
		if err != nil {
			return fmt.Errorf("RichBlockDetails.summary: %w", err)
		}
		v.Summary = u
	}
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("RichBlockDetails.blocks: %w", err)
		}
		out := make([]RichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalRichBlock(r)
			if err != nil {
				return fmt.Errorf("RichBlockDetails.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes RichBlockThinking's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *RichBlockThinking) UnmarshalJSON(data []byte) error {
	type alias RichBlockThinking // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("RichBlockThinking.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockListItem's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockListItem) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockListItem // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichBlockListItem.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichBlockListItem.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes InputRichBlockParagraph's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockParagraph) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockParagraph // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockParagraph.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockSectionHeading's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockSectionHeading) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockSectionHeading // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockSectionHeading.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockPreformatted's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockPreformatted) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockPreformatted // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockPreformatted.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockFooter's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockFooter) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockFooter // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockFooter.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockBlockQuotation's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockBlockQuotation) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockBlockQuotation // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
		Credit json.RawMessage `json:"credit"`
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichBlockBlockQuotation.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichBlockBlockQuotation.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
	...
	if len(aux.Credit) > 0 && string(aux.Credit) != "null" {
		u, err := unmarshalRichText(aux.Credit)
		if err != nil {
			return fmt.Errorf("InputRichBlockBlockQuotation.credit: %w", err)
		}
		v.Credit = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockPullQuotation's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockPullQuotation) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockPullQuotation // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text   json.RawMessage `json:"text"`
		Credit json.RawMessage `json:"credit"`
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockPullQuotation.text: %w", err)
		}
		v.Text = u
	}
	if len(aux.Credit) > 0 && string(aux.Credit) != "null" {
		u, err := unmarshalRichText(aux.Credit)
		if err != nil {
			return fmt.Errorf("InputRichBlockPullQuotation.credit: %w", err)
		}
		v.Credit = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockCollage's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockCollage) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockCollage // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichBlockCollage.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichBlockCollage.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes InputRichBlockSlideshow's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockSlideshow) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockSlideshow // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Blocks json.RawMessage `json:"blocks"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichBlockSlideshow.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichBlockSlideshow.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes InputRichBlockTable's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockTable) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockTable // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Caption json.RawMessage `json:"caption"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Caption) > 0 && string(aux.Caption) != "null" {
		u, err := unmarshalRichText(aux.Caption)
		if err != nil {
			return fmt.Errorf("InputRichBlockTable.caption: %w", err)
		}
		v.Caption = u
	}
	return nil
...
// UnmarshalJSON decodes InputRichBlockDetails's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockDetails) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockDetails // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Summary json.RawMessage `json:"summary"`
		Blocks  json.RawMessage `json:"blocks"`
	...
	if len(aux.Summary) > 0 && string(aux.Summary) != "null" {
		u, err := unmarshalRichText(aux.Summary)
		if err != nil {
			return fmt.Errorf("InputRichBlockDetails.summary: %w", err)
		}
		v.Summary = u
	}
	if len(aux.Blocks) > 0 && string(aux.Blocks) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.Blocks, &raws); err != nil {
			return fmt.Errorf("InputRichBlockDetails.blocks: %w", err)
		}
		out := make([]InputRichBlock, len(raws))
		for i, r := range raws {
			u, err := unmarshalInputRichBlock(r)
			if err != nil {
				return fmt.Errorf("InputRichBlockDetails.blocks[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.Blocks = out
...
// UnmarshalJSON decodes InputRichBlockThinking's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *InputRichBlockThinking) UnmarshalJSON(data []byte) error {
	type alias InputRichBlockThinking // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Text json.RawMessage `json:"text"`
	}{alias: (*alias)(v)}
	...
	if len(aux.Text) > 0 && string(aux.Text) != "null" {
		u, err := unmarshalRichText(aux.Text)
		if err != nil {
			return fmt.Errorf("InputRichBlockThinking.text: %w", err)
		}
		v.Text = u
	}
	return nil
...
// UnmarshalJSON decodes TransactionPartnerUser's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *TransactionPartnerUser) UnmarshalJSON(data []byte) error {
	type alias TransactionPartnerUser // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		PaidMedia json.RawMessage `json:"paid_media"`
	}{alias: (*alias)(v)}
	...
	if len(aux.PaidMedia) > 0 && string(aux.PaidMedia) != "null" {
		var raws []json.RawMessage
		if err := json.Unmarshal(aux.PaidMedia, &raws); err != nil {
			return fmt.Errorf("TransactionPartnerUser.paid_media: %w", err)
		}
		out := make([]PaidMedia, len(raws))
		for i, r := range raws {
			u, err := unmarshalPaidMedia(r)
			if err != nil {
				return fmt.Errorf("TransactionPartnerUser.paid_media[%d]: %w", i, err)
			}
			out[i] = u
		}
		v.PaidMedia = out
...
// UnmarshalJSON decodes TransactionPartnerFragment's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *TransactionPartnerFragment) UnmarshalJSON(data []byte) error {
	type alias TransactionPartnerFragment // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
	...
	if len(aux.WithdrawalState) > 0 && string(aux.WithdrawalState) != "null" {
		u, err := unmarshalRevenueWithdrawalState(aux.WithdrawalState)
		if err != nil {
			return fmt.Errorf("TransactionPartnerFragment.withdrawal_state: %w", err)
		}
		v.WithdrawalState = u
	}
	return nil
...
// UnmarshalJSON decodes StarTransaction's union-typed fields polymorphically —
// encoding/json cannot unmarshal into a bare interface, so each is decoded
// through its union's discriminator-switching unmarshal function.
func (v *StarTransaction) UnmarshalJSON(data []byte) error {
	type alias StarTransaction // methodless copy: avoids recursing into this UnmarshalJSON
	aux := struct {
		*alias
		Source   json.RawMessage `json:"source"`
	...
	if len(aux.Source) > 0 && string(aux.Source) != "null" {
		u, err := unmarshalTransactionPartner(aux.Source)
		if err != nil {
			return fmt.Errorf("StarTransaction.source: %w", err)
		}
		v.Source = u
	}
	if len(aux.Receiver) > 0 && string(aux.Receiver) != "null" {
		u, err := unmarshalTransactionPartner(aux.Receiver)
		if err != nil {
			return fmt.Errorf("StarTransaction.receiver: %w", err)
		}
		v.Receiver = u
	}
	return nil
...
// The Get* methods below implement MessageOrigin: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *MessageOriginUser) GetDate() int64        { return v.Date }
func (v *MessageOriginUser) GetType() string       { return v.Type }
func (v *MessageOriginHiddenUser) GetDate() int64  { return v.Date }
func (v *MessageOriginHiddenUser) GetType() string { return v.Type }
func (v *MessageOriginChat) GetDate() int64        { return v.Date }
func (v *MessageOriginChat) GetType() string       { return v.Type }
...
// The Get* methods below implement PaidMedia: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *PaidMediaLivePhoto) GetType() string { return v.Type }
func (v *PaidMediaPhoto) GetType() string     { return v.Type }
...
// The Get* methods below implement InputPollMedia: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *InputMediaAnimation) GetType() string { return v.Type }
func (v *InputMediaAudio) GetType() string     { return v.Type }
func (v *InputMediaDocument) GetType() string  { return v.Type }
func (v *InputMediaLivePhoto) GetType() string { return v.Type }
func (v *InputMediaLocation) GetType() string  { return v.Type }
func (v *InputMediaPhoto) GetType() string     { return v.Type }
...
// The Get* methods below implement InputPollOptionMedia: fields shared by every member,
// callable on the interface value directly without a type switch.
...
// The Get* methods below implement BackgroundFill: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *BackgroundFillSolid) GetType() string            { return v.Type }
...
// The Get* methods below implement BackgroundType: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *BackgroundTypeFill) GetType() string      { return v.Type }
func (v *BackgroundTypeWallpaper) GetType() string { return v.Type }
...
// The Get* methods below implement ChatMember: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *ChatMemberOwner) GetStatus() string         { return v.Status }
func (v *ChatMemberOwner) GetUser() *User            { return v.User }
func (v *ChatMemberAdministrator) GetStatus() string { return v.Status }
func (v *ChatMemberAdministrator) GetUser() *User    { return v.User }
func (v *ChatMemberMember) GetStatus() string        { return v.Status }
func (v *ChatMemberMember) GetUser() *User           { return v.User }
func (v *ChatMemberRestricted) GetStatus() string    { return v.Status }
func (v *ChatMemberRestricted) GetUser() *User       { return v.User }
func (v *ChatMemberLeft) GetStatus() string          { return v.Status }
...
// The Get* methods below implement StoryAreaType: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *StoryAreaTypeLocation) GetType() string          { return v.Type }
func (v *StoryAreaTypeSuggestedReaction) GetType() string { return v.Type }
func (v *StoryAreaTypeLink) GetType() string              { return v.Type }
...
// The Get* methods below implement ReactionType: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *ReactionTypeEmoji) GetType() string       { return v.Type }
...
// The Get* methods below implement OwnedGift: fields shared by every member,
// callable on the interface value directly without a type switch.
...
func (v *OwnedGiftRegular) GetType() string        { return v.Type }
...
// The Get* methods below implement BotCommandScope: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *BotCommandScopeDefault) GetType() string               { return v.Type }
func (v *BotCommandScopeAllPrivateChats) GetType() string       { return v.Type }
func (v *BotCommandScopeAllGroupChats) GetType() string         { return v.Type }
func (v *BotCommandScopeAllChatAdministrators) GetType() string { return v.Type }
func (v *BotCommandScopeChat) GetType() string                  { return v.Type }
...
// The Get* methods below implement MenuButton: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *MenuButtonCommands) GetType() string { return v.Type }
...
// The Get* methods below implement ChatBoostSource: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *ChatBoostSourcePremium) GetSource() string  { return v.Source }
func (v *ChatBoostSourcePremium) GetUser() *User     { return v.User }
func (v *ChatBoostSourceGiftCode) GetSource() string { return v.Source }
...
// The Get* methods below implement InputMedia: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *InputMediaAnimation) GetCaption() string                  { return v.Caption }
func (v *InputMediaAnimation) GetCaptionEntities() []MessageEntity { return v.CaptionEntities }
func (v *InputMediaAnimation) GetMedia() InputFile                 { return v.Media }
func (v *InputMediaAnimation) GetParseMode() string                { return v.ParseMode }
func (v *InputMediaAudio) GetCaption() string                      { return v.Caption }
func (v *InputMediaAudio) GetCaptionEntities() []MessageEntity     { return v.CaptionEntities }
func (v *InputMediaAudio) GetMedia() InputFile                     { return v.Media }
func (v *InputMediaAudio) GetParseMode() string                    { return v.ParseMode }
func (v *InputMediaDocument) GetCaption() string                   { return v.Caption }
func (v *InputMediaDocument) GetCaptionEntities() []MessageEntity  { return v.CaptionEntities }
func (v *InputMediaDocument) GetMedia() InputFile                  { return v.Media }
func (v *InputMediaDocument) GetParseMode() string                 { return v.ParseMode }
func (v *InputMediaLivePhoto) GetCaption() string                  { return v.Caption }
func (v *InputMediaLivePhoto) GetCaptionEntities() []MessageEntity { return v.CaptionEntities }
func (v *InputMediaLivePhoto) GetMedia() InputFile                 { return v.Media }
func (v *InputMediaLivePhoto) GetParseMode() string                { return v.ParseMode }
func (v *InputMediaPhoto) GetCaption() string                      { return v.Caption }
func (v *InputMediaPhoto) GetCaptionEntities() []MessageEntity     { return v.CaptionEntities }
func (v *InputMediaPhoto) GetMedia() InputFile                     { return v.Media }
func (v *InputMediaPhoto) GetParseMode() string                    { return v.ParseMode }
func (v *InputMediaVideo) GetCaption() string                      { return v.Caption }
func (v *InputMediaVideo) GetCaptionEntities() []MessageEntity     { return v.CaptionEntities }
...
// The Get* methods below implement InputPaidMedia: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *InputPaidMediaLivePhoto) GetMedia() string { return v.Media }
func (v *InputPaidMediaLivePhoto) GetType() string  { return v.Type }
func (v *InputPaidMediaPhoto) GetMedia() string     { return v.Media }
func (v *InputPaidMediaPhoto) GetType() string      { return v.Type }
...
// The Get* methods below implement InputProfilePhoto: fields shared by every member,
// callable on the interface value directly without a type switch.
...
// The Get* methods below implement InputStoryContent: fields shared by every member,
// callable on the interface value directly without a type switch.
...
// The Get* methods below implement RichText: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *RichTextBold) GetType() string                   { return v.Type }
func (v *RichTextItalic) GetType() string                 { return v.Type }
func (v *RichTextUnderline) GetType() string              { return v.Type }
func (v *RichTextStrikethrough) GetType() string          { return v.Type }
func (v *RichTextSpoiler) GetType() string                { return v.Type }
func (v *RichTextDateTime) GetType() string               { return v.Type }
func (v *RichTextTextMention) GetType() string            { return v.Type }
func (v *RichTextSubscript) GetType() string              { return v.Type }
func (v *RichTextSuperscript) GetType() string            { return v.Type }
func (v *RichTextMarked) GetType() string                 { return v.Type }
func (v *RichTextCode) GetType() string                   { return v.Type }
func (v *RichTextCustomEmoji) GetType() string            { return v.Type }
func (v *RichTextMathematicalExpression) GetType() string { return v.Type }
func (v *RichTextURL) GetType() string                    { return v.Type }
func (v *RichTextEmailAddress) GetType() string           { return v.Type }
func (v *RichTextPhoneNumber) GetType() string            { return v.Type }
func (v *RichTextBankCardNumber) GetType() string         { return v.Type }
func (v *RichTextMention) GetType() string                { return v.Type }
func (v *RichTextHashtag) GetType() string                { return v.Type }
func (v *RichTextCashtag) GetType() string                { return v.Type }
func (v *RichTextBotCommand) GetType() string             { return v.Type }
func (v *RichTextAnchor) GetType() string                 { return v.Type }
func (v *RichTextAnchorLink) GetType() string             { return v.Type }
...
// The Get* methods below implement RichBlock: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *RichBlockParagraph) GetType() string              { return v.Type }
func (v *RichBlockSectionHeading) GetType() string         { return v.Type }
func (v *RichBlockPreformatted) GetType() string           { return v.Type }
func (v *RichBlockFooter) GetType() string                 { return v.Type }
func (v *RichBlockDivider) GetType() string                { return v.Type }
func (v *RichBlockMathematicalExpression) GetType() string { return v.Type }
func (v *RichBlockAnchor) GetType() string                 { return v.Type }
func (v *RichBlockList) GetType() string                   { return v.Type }
func (v *RichBlockBlockQuotation) GetType() string         { return v.Type }
func (v *RichBlockPullQuotation) GetType() string          { return v.Type }
func (v *RichBlockCollage) GetType() string                { return v.Type }
func (v *RichBlockSlideshow) GetType() string              { return v.Type }
func (v *RichBlockTable) GetType() string                  { return v.Type }
func (v *RichBlockDetails) GetType() string                { return v.Type }
func (v *RichBlockMap) GetType() string                    { return v.Type }
func (v *RichBlockAnimation) GetType() string              { return v.Type }
func (v *RichBlockAudio) GetType() string                  { return v.Type }
func (v *RichBlockPhoto) GetType() string                  { return v.Type }
func (v *RichBlockVideo) GetType() string                  { return v.Type }
...
type InputRichBlock interface {
	isInputRichBlock()
	GetType() string
	MergeInputRichBlock() MergedInputRichBlock
}
...
// The Get* methods below implement InputRichBlock: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *InputRichBlockParagraph) GetType() string              { return v.Type }
func (v *InputRichBlockSectionHeading) GetType() string         { return v.Type }
func (v *InputRichBlockPreformatted) GetType() string           { return v.Type }
func (v *InputRichBlockFooter) GetType() string                 { return v.Type }
func (v *InputRichBlockDivider) GetType() string                { return v.Type }
func (v *InputRichBlockMathematicalExpression) GetType() string { return v.Type }
func (v *InputRichBlockAnchor) GetType() string                 { return v.Type }
func (v *InputRichBlockList) GetType() string                   { return v.Type }
func (v *InputRichBlockBlockQuotation) GetType() string         { return v.Type }
func (v *InputRichBlockPullQuotation) GetType() string          { return v.Type }
func (v *InputRichBlockCollage) GetType() string                { return v.Type }
func (v *InputRichBlockSlideshow) GetType() string              { return v.Type }
func (v *InputRichBlockTable) GetType() string                  { return v.Type }
func (v *InputRichBlockDetails) GetType() string                { return v.Type }
func (v *InputRichBlockMap) GetType() string                    { return v.Type }
func (v *InputRichBlockAnimation) GetType() string              { return v.Type }
func (v *InputRichBlockAudio) GetType() string                  { return v.Type }
func (v *InputRichBlockPhoto) GetType() string                  { return v.Type }
func (v *InputRichBlockVideo) GetType() string                  { return v.Type }
func (v *InputRichBlockVoiceNote) GetType() string              { return v.Type }
func (v *InputRichBlockThinking) GetType() string               { return v.Type }

// MergedInputRichBlock is the union of every InputRichBlock member's fields, returned by
// InputRichBlock.MergeInputRichBlock() — an escape hatch from type-switching for callers who just
// want to read a field generically. A field a particular member doesn't
// have keeps its zero value here, so it can't be told apart from a field
// that's genuinely zero — check the discriminator field, or type-switch the
// original interface value, when that distinction matters.
type MergedInputRichBlock struct {
...
// The MergeInputRichBlock methods below implement InputRichBlock: every member's fields, folded
// into one flat struct — see MergedInputRichBlock's doc for the tradeoff.
func (v *InputRichBlockParagraph) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
		Text: v.Text,
	}
}
func (v *InputRichBlockSectionHeading) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
		Text: v.Text,
		Size: v.Size,
...
func (v *InputRichBlockPreformatted) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:     v.Type,
		Text:     v.Text,
		Language: v.Language,
...
func (v *InputRichBlockFooter) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
		Text: v.Text,
	}
}
func (v *InputRichBlockDivider) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
	}
}
func (v *InputRichBlockMathematicalExpression) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:       v.Type,
		Expression: v.Expression,
	}
}
func (v *InputRichBlockAnchor) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
		Name: v.Name,
	}
}
func (v *InputRichBlockList) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:  v.Type,
		Items: v.Items,
	}
}
func (v *InputRichBlockBlockQuotation) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:   v.Type,
		Blocks: v.Blocks,
		Credit: v.Credit,
...
func (v *InputRichBlockPullQuotation) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:   v.Type,
		Text:   v.Text,
		Credit: v.Credit,
...
func (v *InputRichBlockCollage) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Blocks:  v.Blocks,
		Caption: v.Caption,
...
func (v *InputRichBlockSlideshow) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Blocks:  v.Blocks,
		Caption: v.Caption,
...
func (v *InputRichBlockTable) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:         v.Type,
		Cells:        v.Cells,
		IsBordered:   v.IsBordered,
...
func (v *InputRichBlockDetails) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Summary: v.Summary,
		Blocks:  v.Blocks,
...
func (v *InputRichBlockMap) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:     v.Type,
		Location: v.Location,
		Zoom:     v.Zoom,
...
func (v *InputRichBlockAnimation) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:      v.Type,
		Animation: v.Animation,
		Caption:   v.Caption,
...
func (v *InputRichBlockAudio) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Audio:   v.Audio,
		Caption: v.Caption,
...
func (v *InputRichBlockPhoto) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Photo:   v.Photo,
		Caption: v.Caption,
...
func (v *InputRichBlockVideo) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:    v.Type,
		Video:   v.Video,
		Caption: v.Caption,
...
func (v *InputRichBlockVoiceNote) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type:      v.Type,
		VoiceNote: v.VoiceNote,
		Caption:   v.Caption,
...
func (v *InputRichBlockThinking) MergeInputRichBlock() MergedInputRichBlock {
	return MergedInputRichBlock{
		Type: v.Type,
		Text: v.Text,
	}
...
// The Get* methods below implement InlineQueryResult: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *InlineQueryResultCachedAudio) GetID() string                         { return v.ID }
func (v *InlineQueryResultCachedAudio) GetReplyMarkup() *InlineKeyboardMarkup { return v.ReplyMarkup }
func (v *InlineQueryResultCachedAudio) GetType() string                       { return v.Type }
func (v *InlineQueryResultCachedDocument) GetID() string                      { return v.ID }
func (v *InlineQueryResultCachedDocument) GetReplyMarkup() *InlineKeyboardMarkup {
	return v.ReplyMarkup
}
func (v *InlineQueryResultCachedDocument) GetType() string                  { return v.Type }
func (v *InlineQueryResultCachedGif) GetID() string                         { return v.ID }
func (v *InlineQueryResultCachedGif) GetReplyMarkup() *InlineKeyboardMarkup { return v.ReplyMarkup }
func (v *InlineQueryResultCachedGif) GetType() string                       { return v.Type }
func (v *InlineQueryResultCachedMpeg4Gif) GetID() string                    { return v.ID }
func (v *InlineQueryResultCachedMpeg4Gif) GetReplyMarkup() *InlineKeyboardMarkup {
	return v.ReplyMarkup
}
func (v *InlineQueryResultCachedMpeg4Gif) GetType() string                      { return v.Type }
func (v *InlineQueryResultCachedPhoto) GetID() string                           { return v.ID }
func (v *InlineQueryResultCachedPhoto) GetReplyMarkup() *InlineKeyboardMarkup   { return v.ReplyMarkup }
func (v *InlineQueryResultCachedPhoto) GetType() string                         { return v.Type }
func (v *InlineQueryResultCachedSticker) GetID() string                         { return v.ID }
func (v *InlineQueryResultCachedSticker) GetReplyMarkup() *InlineKeyboardMarkup { return v.ReplyMarkup }
func (v *InlineQueryResultCachedSticker) GetType() string                       { return v.Type }
func (v *InlineQueryResultCachedVideo) GetID() string                           { return v.ID }
func (v *InlineQueryResultCachedVideo) GetReplyMarkup() *InlineKeyboardMarkup   { return v.ReplyMarkup }
func (v *InlineQueryResultCachedVideo) GetType() string                         { return v.Type }
func (v *InlineQueryResultCachedVoice) GetID() string                           { return v.ID }
func (v *InlineQueryResultCachedVoice) GetReplyMarkup() *InlineKeyboardMarkup   { return v.ReplyMarkup }
func (v *InlineQueryResultCachedVoice) GetType() string                         { return v.Type }
func (v *InlineQueryResultArticle) GetID() string                               { return v.ID }
func (v *InlineQueryResultArticle) GetReplyMarkup() *InlineKeyboardMarkup       { return v.ReplyMarkup }
func (v *InlineQueryResultArticle) GetType() string                             { return v.Type }
func (v *InlineQueryResultAudio) GetID() string                                 { return v.ID }
func (v *InlineQueryResultAudio) GetReplyMarkup() *InlineKeyboardMarkup         { return v.ReplyMarkup }
func (v *InlineQueryResultAudio) GetType() string                               { return v.Type }
func (v *InlineQueryResultContact) GetID() string                               { return v.ID }
func (v *InlineQueryResultContact) GetReplyMarkup() *InlineKeyboardMarkup       { return v.ReplyMarkup }
func (v *InlineQueryResultContact) GetType() string                             { return v.Type }
func (v *InlineQueryResultGame) GetID() string                                  { return v.ID }
func (v *InlineQueryResultGame) GetReplyMarkup() *InlineKeyboardMarkup          { return v.ReplyMarkup }
func (v *InlineQueryResultGame) GetType() string                                { return v.Type }
func (v *InlineQueryResultDocument) GetID() string                              { return v.ID }
func (v *InlineQueryResultDocument) GetReplyMarkup() *InlineKeyboardMarkup      { return v.ReplyMarkup }
func (v *InlineQueryResultDocument) GetType() string                            { return v.Type }
func (v *InlineQueryResultGif) GetID() string                                   { return v.ID }
func (v *InlineQueryResultGif) GetReplyMarkup() *InlineKeyboardMarkup           { return v.ReplyMarkup }
func (v *InlineQueryResultGif) GetType() string                                 { return v.Type }
func (v *InlineQueryResultLocation) GetID() string                              { return v.ID }
func (v *InlineQueryResultLocation) GetReplyMarkup() *InlineKeyboardMarkup      { return v.ReplyMarkup }
func (v *InlineQueryResultLocation) GetType() string                            { return v.Type }
func (v *InlineQueryResultMpeg4Gif) GetID() string                              { return v.ID }
func (v *InlineQueryResultMpeg4Gif) GetReplyMarkup() *InlineKeyboardMarkup      { return v.ReplyMarkup }
func (v *InlineQueryResultMpeg4Gif) GetType() string                            { return v.Type }
func (v *InlineQueryResultPhoto) GetID() string                                 { return v.ID }
func (v *InlineQueryResultPhoto) GetReplyMarkup() *InlineKeyboardMarkup         { return v.ReplyMarkup }
func (v *InlineQueryResultPhoto) GetType() string                               { return v.Type }
func (v *InlineQueryResultVenue) GetID() string                                 { return v.ID }
func (v *InlineQueryResultVenue) GetReplyMarkup() *InlineKeyboardMarkup         { return v.ReplyMarkup }
func (v *InlineQueryResultVenue) GetType() string                               { return v.Type }
func (v *InlineQueryResultVideo) GetID() string                                 { return v.ID }
func (v *InlineQueryResultVideo) GetReplyMarkup() *InlineKeyboardMarkup         { return v.ReplyMarkup }
func (v *InlineQueryResultVideo) GetType() string                               { return v.Type }
func (v *InlineQueryResultVoice) GetID() string                                 { return v.ID }
...
// The Get* methods below implement RevenueWithdrawalState: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *RevenueWithdrawalStatePending) GetType() string   { return v.Type }
...
// The Get* methods below implement TransactionPartner: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *TransactionPartnerUser) GetType() string             { return v.Type }
func (v *TransactionPartnerChat) GetType() string             { return v.Type }
func (v *TransactionPartnerAffiliateProgram) GetType() string { return v.Type }
func (v *TransactionPartnerFragment) GetType() string         { return v.Type }
func (v *TransactionPartnerTelegramAds) GetType() string      { return v.Type }
...
// The Get* methods below implement PassportElementError: fields shared by every member,
// callable on the interface value directly without a type switch.
func (v *PassportElementErrorDataField) GetMessage() string        { return v.Message }
func (v *PassportElementErrorDataField) GetSource() string         { return v.Source }
func (v *PassportElementErrorDataField) GetType() string           { return v.Type }
func (v *PassportElementErrorFrontSide) GetMessage() string        { return v.Message }
func (v *PassportElementErrorFrontSide) GetSource() string         { return v.Source }
func (v *PassportElementErrorFrontSide) GetType() string           { return v.Type }
func (v *PassportElementErrorReverseSide) GetMessage() string      { return v.Message }
func (v *PassportElementErrorReverseSide) GetSource() string       { return v.Source }
func (v *PassportElementErrorReverseSide) GetType() string         { return v.Type }
func (v *PassportElementErrorSelfie) GetMessage() string           { return v.Message }
func (v *PassportElementErrorSelfie) GetSource() string            { return v.Source }
func (v *PassportElementErrorSelfie) GetType() string              { return v.Type }
func (v *PassportElementErrorFile) GetMessage() string             { return v.Message }
func (v *PassportElementErrorFile) GetSource() string              { return v.Source }
func (v *PassportElementErrorFile) GetType() string                { return v.Type }
func (v *PassportElementErrorFiles) GetMessage() string            { return v.Message }
func (v *PassportElementErrorFiles) GetSource() string             { return v.Source }
func (v *PassportElementErrorFiles) GetType() string               { return v.Type }
func (v *PassportElementErrorTranslationFile) GetMessage() string  { return v.Message }
func (v *PassportElementErrorTranslationFile) GetSource() string   { return v.Source }
func (v *PassportElementErrorTranslationFile) GetType() string     { return v.Type }
func (v *PassportElementErrorTranslationFiles) GetMessage() string { return v.Message }
func (v *PassportElementErrorTranslationFiles) GetSource() string  { return v.Source }
func (v *PassportElementErrorTranslationFiles) GetType() string    { return v.Type }
...
func unmarshalBackgroundFill(data []byte) (BackgroundFill, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("BackgroundFill: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "solid":
		v := new(BackgroundFillSolid)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundFill(type=solid): %w", err)
		}
		return v, nil
	case "gradient":
		v := new(BackgroundFillGradient)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundFill(type=gradient): %w", err)
		}
		return v, nil
	case "freeform_gradient":
		v := new(BackgroundFillFreeformGradient)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundFill(type=freeform_gradient): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("BackgroundFill: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalBackgroundType decodes one BackgroundType union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalBackgroundType(data []byte) (BackgroundType, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("BackgroundType: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "fill":
		v := new(BackgroundTypeFill)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundType(type=fill): %w", err)
		}
		return v, nil
	case "wallpaper":
		v := new(BackgroundTypeWallpaper)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundType(type=wallpaper): %w", err)
		}
		return v, nil
	case "pattern":
		v := new(BackgroundTypePattern)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundType(type=pattern): %w", err)
		}
		return v, nil
	case "chat_theme":
		v := new(BackgroundTypeChatTheme)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BackgroundType(type=chat_theme): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("BackgroundType: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalBotCommandScope decodes one BotCommandScope union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalBotCommandScope(data []byte) (BotCommandScope, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("BotCommandScope: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "default":
		v := new(BotCommandScopeDefault)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=default): %w", err)
		}
		return v, nil
	case "all_private_chats":
		v := new(BotCommandScopeAllPrivateChats)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=all_private_chats): %w", err)
		}
		return v, nil
	case "all_group_chats":
		v := new(BotCommandScopeAllGroupChats)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=all_group_chats): %w", err)
		}
		return v, nil
	case "all_chat_administrators":
		v := new(BotCommandScopeAllChatAdministrators)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=all_chat_administrators): %w", err)
		}
		return v, nil
	case "chat":
		v := new(BotCommandScopeChat)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=chat): %w", err)
		}
		return v, nil
	case "chat_administrators":
		v := new(BotCommandScopeChatAdministrators)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=chat_administrators): %w", err)
		}
		return v, nil
	case "chat_member":
		v := new(BotCommandScopeChatMember)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("BotCommandScope(type=chat_member): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("BotCommandScope: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalChatBoostSource decodes one ChatBoostSource union value into its concrete member
// type, switching on the "source" discriminator field.
func unmarshalChatBoostSource(data []byte) (ChatBoostSource, error) {
	var disc struct {
		Value string `json:"source"`
	}
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("ChatBoostSource: reading source discriminator: %w", err)
	}
	switch disc.Value {
	case "premium":
		v := new(ChatBoostSourcePremium)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatBoostSource(source=premium): %w", err)
		}
		return v, nil
	case "gift_code":
		v := new(ChatBoostSourceGiftCode)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatBoostSource(source=gift_code): %w", err)
		}
		return v, nil
	case "giveaway":
		v := new(ChatBoostSourceGiveaway)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatBoostSource(source=giveaway): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("ChatBoostSource: unknown source %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalChatMember decodes one ChatMember union value into its concrete member
// type, switching on the "status" discriminator field.
func unmarshalChatMember(data []byte) (ChatMember, error) {
	var disc struct {
		Value string `json:"status"`
	}
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("ChatMember: reading status discriminator: %w", err)
	}
	switch disc.Value {
	case "creator":
		v := new(ChatMemberOwner)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=creator): %w", err)
		}
		return v, nil
	case "administrator":
		v := new(ChatMemberAdministrator)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=administrator): %w", err)
		}
		return v, nil
	case "member":
		v := new(ChatMemberMember)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=member): %w", err)
		}
		return v, nil
	case "restricted":
		v := new(ChatMemberRestricted)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=restricted): %w", err)
		}
		return v, nil
	case "left":
		v := new(ChatMemberLeft)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=left): %w", err)
		}
		return v, nil
	case "kicked":
		v := new(ChatMemberBanned)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ChatMember(status=kicked): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("ChatMember: unknown status %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputMedia decodes one InputMedia union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputMedia(data []byte) (InputMedia, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputMedia: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "animation":
		v := new(InputMediaAnimation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=animation): %w", err)
		}
		return v, nil
	case "audio":
		v := new(InputMediaAudio)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=audio): %w", err)
		}
		return v, nil
	case "document":
		v := new(InputMediaDocument)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=document): %w", err)
		}
		return v, nil
	case "live_photo":
		v := new(InputMediaLivePhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=live_photo): %w", err)
		}
		return v, nil
	case "photo":
		v := new(InputMediaPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=photo): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputMediaVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputMedia(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputMedia: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputPaidMedia decodes one InputPaidMedia union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputPaidMedia(data []byte) (InputPaidMedia, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputPaidMedia: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "live_photo":
		v := new(InputPaidMediaLivePhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPaidMedia(type=live_photo): %w", err)
		}
		return v, nil
	case "photo":
		v := new(InputPaidMediaPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPaidMedia(type=photo): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputPaidMediaVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPaidMedia(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputPaidMedia: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputPollMedia decodes one InputPollMedia union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputPollMedia(data []byte) (InputPollMedia, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputPollMedia: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "animation":
		v := new(InputMediaAnimation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=animation): %w", err)
		}
		return v, nil
	case "audio":
		v := new(InputMediaAudio)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=audio): %w", err)
		}
		return v, nil
	case "document":
		v := new(InputMediaDocument)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=document): %w", err)
		}
		return v, nil
	case "live_photo":
		v := new(InputMediaLivePhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=live_photo): %w", err)
		}
		return v, nil
	case "location":
		v := new(InputMediaLocation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=location): %w", err)
		}
		return v, nil
	case "photo":
		v := new(InputMediaPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=photo): %w", err)
		}
		return v, nil
	case "venue":
		v := new(InputMediaVenue)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=venue): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputMediaVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollMedia(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputPollMedia: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputPollOptionMedia decodes one InputPollOptionMedia union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputPollOptionMedia(data []byte) (InputPollOptionMedia, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputPollOptionMedia: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "animation":
		v := new(InputMediaAnimation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=animation): %w", err)
		}
		return v, nil
	case "link":
		v := new(InputMediaLink)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=link): %w", err)
		}
		return v, nil
	case "live_photo":
		v := new(InputMediaLivePhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=live_photo): %w", err)
		}
		return v, nil
	case "location":
		v := new(InputMediaLocation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=location): %w", err)
		}
		return v, nil
	case "photo":
		v := new(InputMediaPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=photo): %w", err)
		}
		return v, nil
	case "sticker":
		v := new(InputMediaSticker)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=sticker): %w", err)
		}
		return v, nil
	case "venue":
		v := new(InputMediaVenue)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=venue): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputMediaVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputPollOptionMedia(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputPollOptionMedia: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputProfilePhoto decodes one InputProfilePhoto union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputProfilePhoto(data []byte) (InputProfilePhoto, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputProfilePhoto: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "static":
		v := new(InputProfilePhotoStatic)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputProfilePhoto(type=static): %w", err)
		}
		return v, nil
	case "animated":
		v := new(InputProfilePhotoAnimated)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputProfilePhoto(type=animated): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputProfilePhoto: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputRichBlock decodes one InputRichBlock union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputRichBlock(data []byte) (InputRichBlock, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputRichBlock: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "paragraph":
		v := new(InputRichBlockParagraph)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=paragraph): %w", err)
		}
		return v, nil
	case "heading":
		v := new(InputRichBlockSectionHeading)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=heading): %w", err)
		}
		return v, nil
	case "pre":
		v := new(InputRichBlockPreformatted)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=pre): %w", err)
		}
		return v, nil
	case "footer":
		v := new(InputRichBlockFooter)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=footer): %w", err)
		}
		return v, nil
	case "divider":
		v := new(InputRichBlockDivider)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=divider): %w", err)
		}
		return v, nil
	case "mathematical_expression":
		v := new(InputRichBlockMathematicalExpression)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=mathematical_expression): %w", err)
		}
		return v, nil
	case "anchor":
		v := new(InputRichBlockAnchor)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=anchor): %w", err)
		}
		return v, nil
	case "list":
		v := new(InputRichBlockList)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=list): %w", err)
		}
		return v, nil
	case "blockquote":
		v := new(InputRichBlockBlockQuotation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=blockquote): %w", err)
		}
		return v, nil
	case "pullquote":
		v := new(InputRichBlockPullQuotation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=pullquote): %w", err)
		}
		return v, nil
	case "collage":
		v := new(InputRichBlockCollage)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=collage): %w", err)
		}
		return v, nil
	case "slideshow":
		v := new(InputRichBlockSlideshow)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=slideshow): %w", err)
		}
		return v, nil
	case "table":
		v := new(InputRichBlockTable)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=table): %w", err)
		}
		return v, nil
	case "details":
		v := new(InputRichBlockDetails)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=details): %w", err)
		}
		return v, nil
	case "map":
		v := new(InputRichBlockMap)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=map): %w", err)
		}
		return v, nil
	case "animation":
		v := new(InputRichBlockAnimation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=animation): %w", err)
		}
		return v, nil
	case "audio":
		v := new(InputRichBlockAudio)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=audio): %w", err)
		}
		return v, nil
	case "photo":
		v := new(InputRichBlockPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=photo): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputRichBlockVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=video): %w", err)
		}
		return v, nil
	case "voice_note":
		v := new(InputRichBlockVoiceNote)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=voice_note): %w", err)
		}
		return v, nil
	case "thinking":
		v := new(InputRichBlockThinking)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputRichBlock(type=thinking): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputRichBlock: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalInputStoryContent decodes one InputStoryContent union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalInputStoryContent(data []byte) (InputStoryContent, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("InputStoryContent: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "photo":
		v := new(InputStoryContentPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputStoryContent(type=photo): %w", err)
		}
		return v, nil
	case "video":
		v := new(InputStoryContentVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("InputStoryContent(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("InputStoryContent: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalMenuButton decodes one MenuButton union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalMenuButton(data []byte) (MenuButton, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("MenuButton: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "commands":
		v := new(MenuButtonCommands)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MenuButton(type=commands): %w", err)
		}
		return v, nil
	case "web_app":
		v := new(MenuButtonWebApp)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MenuButton(type=web_app): %w", err)
		}
		return v, nil
	case "default":
		v := new(MenuButtonDefault)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MenuButton(type=default): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("MenuButton: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalMessageOrigin decodes one MessageOrigin union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalMessageOrigin(data []byte) (MessageOrigin, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("MessageOrigin: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "user":
		v := new(MessageOriginUser)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MessageOrigin(type=user): %w", err)
		}
		return v, nil
	case "hidden_user":
		v := new(MessageOriginHiddenUser)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MessageOrigin(type=hidden_user): %w", err)
		}
		return v, nil
	case "chat":
		v := new(MessageOriginChat)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MessageOrigin(type=chat): %w", err)
		}
		return v, nil
	case "channel":
		v := new(MessageOriginChannel)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("MessageOrigin(type=channel): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("MessageOrigin: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalOwnedGift decodes one OwnedGift union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalOwnedGift(data []byte) (OwnedGift, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("OwnedGift: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "regular":
		v := new(OwnedGiftRegular)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("OwnedGift(type=regular): %w", err)
		}
		return v, nil
	case "unique":
		v := new(OwnedGiftUnique)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("OwnedGift(type=unique): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("OwnedGift: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalPaidMedia decodes one PaidMedia union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalPaidMedia(data []byte) (PaidMedia, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("PaidMedia: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "live_photo":
		v := new(PaidMediaLivePhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PaidMedia(type=live_photo): %w", err)
		}
		return v, nil
	case "photo":
		v := new(PaidMediaPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PaidMedia(type=photo): %w", err)
		}
		return v, nil
	case "preview":
		v := new(PaidMediaPreview)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PaidMedia(type=preview): %w", err)
		}
		return v, nil
	case "video":
		v := new(PaidMediaVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PaidMedia(type=video): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("PaidMedia: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalPassportElementError decodes one PassportElementError union value into its concrete member
// type, switching on the "source" discriminator field.
func unmarshalPassportElementError(data []byte) (PassportElementError, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("PassportElementError: reading source discriminator: %w", err)
	}
	switch disc.Value {
	case "data":
		v := new(PassportElementErrorDataField)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=data): %w", err)
		}
		return v, nil
	case "front_side":
		v := new(PassportElementErrorFrontSide)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=front_side): %w", err)
		}
		return v, nil
	case "reverse_side":
		v := new(PassportElementErrorReverseSide)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=reverse_side): %w", err)
		}
		return v, nil
	case "selfie":
		v := new(PassportElementErrorSelfie)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=selfie): %w", err)
		}
		return v, nil
	case "file":
		v := new(PassportElementErrorFile)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=file): %w", err)
		}
		return v, nil
	case "files":
		v := new(PassportElementErrorFiles)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=files): %w", err)
		}
		return v, nil
	case "translation_file":
		v := new(PassportElementErrorTranslationFile)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=translation_file): %w", err)
		}
		return v, nil
	case "translation_files":
		v := new(PassportElementErrorTranslationFiles)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=translation_files): %w", err)
		}
		return v, nil
	case "unspecified":
		v := new(PassportElementErrorUnspecified)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("PassportElementError(source=unspecified): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("PassportElementError: unknown source %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalReactionType decodes one ReactionType union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalReactionType(data []byte) (ReactionType, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("ReactionType: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "emoji":
		v := new(ReactionTypeEmoji)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ReactionType(type=emoji): %w", err)
		}
		return v, nil
	case "custom_emoji":
		v := new(ReactionTypeCustomEmoji)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ReactionType(type=custom_emoji): %w", err)
		}
		return v, nil
	case "paid":
		v := new(ReactionTypePaid)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("ReactionType(type=paid): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("ReactionType: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalRevenueWithdrawalState decodes one RevenueWithdrawalState union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalRevenueWithdrawalState(data []byte) (RevenueWithdrawalState, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("RevenueWithdrawalState: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "pending":
		v := new(RevenueWithdrawalStatePending)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RevenueWithdrawalState(type=pending): %w", err)
		}
		return v, nil
	case "succeeded":
		v := new(RevenueWithdrawalStateSucceeded)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RevenueWithdrawalState(type=succeeded): %w", err)
		}
		return v, nil
	case "failed":
		v := new(RevenueWithdrawalStateFailed)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RevenueWithdrawalState(type=failed): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("RevenueWithdrawalState: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalRichBlock decodes one RichBlock union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalRichBlock(data []byte) (RichBlock, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("RichBlock: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "paragraph":
		v := new(RichBlockParagraph)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=paragraph): %w", err)
		}
		return v, nil
	case "heading":
		v := new(RichBlockSectionHeading)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=heading): %w", err)
		}
		return v, nil
	case "pre":
		v := new(RichBlockPreformatted)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=pre): %w", err)
		}
		return v, nil
	case "footer":
		v := new(RichBlockFooter)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=footer): %w", err)
		}
		return v, nil
	case "divider":
		v := new(RichBlockDivider)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=divider): %w", err)
		}
		return v, nil
	case "mathematical_expression":
		v := new(RichBlockMathematicalExpression)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=mathematical_expression): %w", err)
		}
		return v, nil
	case "anchor":
		v := new(RichBlockAnchor)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=anchor): %w", err)
		}
		return v, nil
	case "list":
		v := new(RichBlockList)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=list): %w", err)
		}
		return v, nil
	case "blockquote":
		v := new(RichBlockBlockQuotation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=blockquote): %w", err)
		}
		return v, nil
	case "pullquote":
		v := new(RichBlockPullQuotation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=pullquote): %w", err)
		}
		return v, nil
	case "collage":
		v := new(RichBlockCollage)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=collage): %w", err)
		}
		return v, nil
	case "slideshow":
		v := new(RichBlockSlideshow)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=slideshow): %w", err)
		}
		return v, nil
	case "table":
		v := new(RichBlockTable)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=table): %w", err)
		}
		return v, nil
	case "details":
		v := new(RichBlockDetails)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=details): %w", err)
		}
		return v, nil
	case "map":
		v := new(RichBlockMap)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=map): %w", err)
		}
		return v, nil
	case "animation":
		v := new(RichBlockAnimation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=animation): %w", err)
		}
		return v, nil
	case "audio":
		v := new(RichBlockAudio)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=audio): %w", err)
		}
		return v, nil
	case "photo":
		v := new(RichBlockPhoto)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=photo): %w", err)
		}
		return v, nil
	case "video":
		v := new(RichBlockVideo)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=video): %w", err)
		}
		return v, nil
	case "voice_note":
		v := new(RichBlockVoiceNote)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=voice_note): %w", err)
		}
		return v, nil
	case "thinking":
		v := new(RichBlockThinking)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichBlock(type=thinking): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("RichBlock: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalRichText decodes one RichText union value into its concrete member
// type, switching on the "type" discriminator field.
// RichText also accepts a bare JSON string (plain text) or a JSON
// array of RichText (concatenated spans) in place of an object — both
// tried first, before the discriminated object switch below.
func unmarshalRichText(data []byte) (RichText, error) {
	var plain string
	if err := json.Unmarshal(data, &plain); err == nil {
		return RichPlainText(plain), nil
	}
	var rawSeq []json.RawMessage
	if err := json.Unmarshal(data, &rawSeq); err == nil {
		seq := make(RichTextSequence, len(rawSeq))
		for i, raw := range rawSeq {
			v, err := unmarshalRichText(raw)
			if err != nil {
				return nil, fmt.Errorf("RichText[%d]: %w", i, err)
			}
			seq[i] = v
		}
		return seq, nil
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("RichText: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "bold":
		v := new(RichTextBold)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=bold): %w", err)
		}
		return v, nil
	case "italic":
		v := new(RichTextItalic)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=italic): %w", err)
		}
		return v, nil
	case "underline":
		v := new(RichTextUnderline)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=underline): %w", err)
		}
		return v, nil
	case "strikethrough":
		v := new(RichTextStrikethrough)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=strikethrough): %w", err)
		}
		return v, nil
	case "spoiler":
		v := new(RichTextSpoiler)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=spoiler): %w", err)
		}
		return v, nil
	case "date_time":
		v := new(RichTextDateTime)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=date_time): %w", err)
		}
		return v, nil
	case "text_mention":
		v := new(RichTextTextMention)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=text_mention): %w", err)
		}
		return v, nil
	case "subscript":
		v := new(RichTextSubscript)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=subscript): %w", err)
		}
		return v, nil
	case "superscript":
		v := new(RichTextSuperscript)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=superscript): %w", err)
		}
		return v, nil
	case "marked":
		v := new(RichTextMarked)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=marked): %w", err)
		}
		return v, nil
	case "code":
		v := new(RichTextCode)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=code): %w", err)
		}
		return v, nil
	case "custom_emoji":
		v := new(RichTextCustomEmoji)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=custom_emoji): %w", err)
		}
		return v, nil
	case "mathematical_expression":
		v := new(RichTextMathematicalExpression)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=mathematical_expression): %w", err)
		}
		return v, nil
	case "url":
		v := new(RichTextURL)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=url): %w", err)
		}
		return v, nil
	case "email_address":
		v := new(RichTextEmailAddress)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=email_address): %w", err)
		}
		return v, nil
	case "phone_number":
		v := new(RichTextPhoneNumber)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=phone_number): %w", err)
		}
		return v, nil
	case "bank_card_number":
		v := new(RichTextBankCardNumber)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=bank_card_number): %w", err)
		}
		return v, nil
	case "mention":
		v := new(RichTextMention)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=mention): %w", err)
		}
		return v, nil
	case "hashtag":
		v := new(RichTextHashtag)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=hashtag): %w", err)
		}
		return v, nil
	case "cashtag":
		v := new(RichTextCashtag)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=cashtag): %w", err)
		}
		return v, nil
	case "bot_command":
		v := new(RichTextBotCommand)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=bot_command): %w", err)
		}
		return v, nil
	case "anchor":
		v := new(RichTextAnchor)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=anchor): %w", err)
		}
		return v, nil
	case "anchor_link":
		v := new(RichTextAnchorLink)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=anchor_link): %w", err)
		}
		return v, nil
	case "reference":
		v := new(RichTextReference)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=reference): %w", err)
		}
		return v, nil
	case "reference_link":
		v := new(RichTextReferenceLink)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("RichText(type=reference_link): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("RichText: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalStoryAreaType decodes one StoryAreaType union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalStoryAreaType(data []byte) (StoryAreaType, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("StoryAreaType: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "location":
		v := new(StoryAreaTypeLocation)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("StoryAreaType(type=location): %w", err)
		}
		return v, nil
	case "suggested_reaction":
		v := new(StoryAreaTypeSuggestedReaction)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("StoryAreaType(type=suggested_reaction): %w", err)
		}
		return v, nil
	case "link":
		v := new(StoryAreaTypeLink)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("StoryAreaType(type=link): %w", err)
		}
		return v, nil
	case "weather":
		v := new(StoryAreaTypeWeather)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("StoryAreaType(type=weather): %w", err)
		}
		return v, nil
	case "unique_gift":
		v := new(StoryAreaTypeUniqueGift)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("StoryAreaType(type=unique_gift): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("StoryAreaType: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}

// unmarshalTransactionPartner decodes one TransactionPartner union value into its concrete member
// type, switching on the "type" discriminator field.
func unmarshalTransactionPartner(data []byte) (TransactionPartner, error) {
	...
	if err := json.Unmarshal(data, &disc); err != nil {
		return nil, fmt.Errorf("TransactionPartner: reading type discriminator: %w", err)
	}
	switch disc.Value {
	case "user":
		v := new(TransactionPartnerUser)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=user): %w", err)
		}
		return v, nil
	case "chat":
		v := new(TransactionPartnerChat)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=chat): %w", err)
		}
		return v, nil
	case "affiliate_program":
		v := new(TransactionPartnerAffiliateProgram)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=affiliate_program): %w", err)
		}
		return v, nil
	case "fragment":
		v := new(TransactionPartnerFragment)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=fragment): %w", err)
		}
		return v, nil
	case "telegram_ads":
		v := new(TransactionPartnerTelegramAds)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=telegram_ads): %w", err)
		}
		return v, nil
	case "telegram_api":
		v := new(TransactionPartnerTelegramApi)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=telegram_api): %w", err)
		}
		return v, nil
	case "other":
		v := new(TransactionPartnerOther)
		if err := json.Unmarshal(data, v); err != nil {
			return nil, fmt.Errorf("TransactionPartner(type=other): %w", err)
		}
		return v, nil
	default:
		return nil, fmt.Errorf("TransactionPartner: unknown type %q (a Bot API version this build of golagram predates?)", disc.Value)
	}
}
